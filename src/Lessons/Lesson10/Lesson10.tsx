...
import { Style, ToDolist, Title, InputElement, Button1, List, Button2 } from "./styles";
...
<InputElement type = "text" value= {inputValue} onChange={inputChange} placeholder="Введите задание..." />
